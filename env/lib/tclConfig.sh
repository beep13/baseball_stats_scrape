...
# installed.
TCL_PREFIX='/Volumes/MAIN/PROGRAMMING/projects/miniconda_test/env'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/Volumes/MAIN/PROGRAMMING/projects/miniconda_test/env'
...
TCL_EXTRA_CFLAGS='-march=core2 -mtune=haswell -mssse3 -ftree-vectorize -fPIC -fPIE -fstack-protector-strong -O2 -pipe -isystem /Volumes/MAIN/PROGRAMMING/projects/miniconda_test/env/include -fdebug-prefix-map=/var/folders/sy/f16zz6x50xz3113nwtb9bvq00000gp/T/abs_a0b3437e-5427-478c-9c0d-3bf16a61dfacwyldasds/croots/recipe/tk_1654088774077/work=/usr/local/src/conda/tk-8.6.12 -fdebug-prefix-map=/Volumes/MAIN/PROGRAMMING/projects/miniconda_test/env=/usr/local/src/conda-prefix -pipe  -arch x86_64 -D_FORTIFY_SOURCE=2 -isystem /Volumes/MAIN/PROGRAMMING/projects/miniconda_test/env/include -mmacosx-version-min=10.9 '
...
TCL_LD_FLAGS='-Wl,-pie -Wl,-headerpad_max_install_names -Wl,-dead_strip_dylibs -Wl,-rpath,/Volumes/MAIN/PROGRAMMING/projects/miniconda_test/env/lib -L/Volumes/MAIN/PROGRAMMING/projects/miniconda_test/env/lib -headerpad_max_install_names -Wl,-search_paths_first '
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/Volumes/MAIN/PROGRAMMING/projects/miniconda_test/env/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/Volumes/MAIN/PROGRAMMING/projects/miniconda_test/env/include'
...
TCL_PACKAGE_PATH='{/Volumes/MAIN/PROGRAMMING/projects/miniconda_test/env/lib} '
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/Volumes/MAIN/PROGRAMMING/projects/miniconda_test/env/lib -ltclstub8.6'
...
TCL_STUB_LIB_PATH='/Volumes/MAIN/PROGRAMMING/projects/miniconda_test/env/lib/libtclstub8.6.a'
